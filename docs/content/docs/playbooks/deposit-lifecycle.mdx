...
```bash
peer deposit create --amount 1000 --min 100 --max 1000 --platforms wise --currencies USD --rate 1
peer deposit create --amount 1000 --min 100 --max 1000 --platforms wise --currencies USD --rate 1 --yes
```
