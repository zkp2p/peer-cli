...
export const stakeDefinitions: CommandDefinition[] = [
  ...
  },
  {
    ...
    args: [
      ...
      { name: 'paymentMethodHash', description: 'Payment method bytes32 hash.', schema: { type: 'string', description: 'Payment method hash.' }, optionFlags: ['--payment-method-hash <hash>'] },
    ],
